...
// 태양계 행성 지역 10곳 (각 180x180). 꿈의우주 UFO 정거장에서 별이에게 말을 걸고 행성을 골라 UFO 로 간다.
// 행성마다 지형·하늘·장식이 다르고, 사는 포켓몬은 data/creatures.json 의 zones.p_*.wild 종 목록으로 채운다.
// 행성마다 UFO 정거장이 있어 꿈의우주로 돌아가거나 다른 행성으로 갈 수 있다.
export const PLANETS = [
  { id: 'sun', zone: 'p_sun', name: '태양', emoji: '☀️', tint: '#ffb020', title: '활활 타는 우리 별', gravity: 1.3, gravityText: '아주 세다', quiz: 'volcano',
    ...
    greet: '여긴 정말 뜨거워! 검은 흑점 웅덩이는 밟으면 안 돼.', arrive: '태양에 도착! 불꽃이 솟는 뜨거운 들판이야. 검은 흑점 웅덩이는 밟을 수 없어. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'mercury', zone: 'p_mercury', name: '수성', emoji: '🪨', tint: '#b5b0a8', title: '태양에 가장 가까운 작은 행성', gravity: 0.5, gravityText: '약하다 (높이 뛴다)', quiz: 'cave',
    ...
    greet: '동쪽은 뜨거운 낮, 서쪽은 차가운 밤이야. 중력이 약해서 높이 뛸 수 있어.', arrive: '수성에 도착! 크레이터가 가득한 회색 바위 행성이야. 중력이 약해서 높이 뛸 수 있어. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'venus', zone: 'p_venus', name: '금성', emoji: '🌕', tint: '#e8c77a', title: '구름에 덮인 지구의 쌍둥이', gravity: 0.95, gravityText: '지구와 비슷', quiz: 'cave',
    ...
    greet: '노란 구름이 두꺼워서 멀리가 잘 안 보여. 초록 산성 호수는 조심!', arrive: '금성에 도착! 노란 구름과 산성 호수가 있는 뜨거운 행성이야. 초록 호수는 밟을 수 없어. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'earth', zone: 'p_earth', name: '지구', emoji: '🌍', tint: '#4fa3ff', title: '우리가 사는 파란 행성', gravity: 1, gravityText: '보통', quiz: 'forest',
    ...
    greet: '초록 들판과 파란 호수, 우리 집에 온 것 같지? 무지개도 떠 있어!', arrive: '지구에 도착! 초록 들판과 파란 호수, 나무와 꽃이 가득한 우리 행성이야. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'mars', zone: 'p_mars', name: '화성', emoji: '🔴', tint: '#d9603b', title: '붉은 먼지의 행성', gravity: 0.5, gravityText: '약하다 (높이 뛴다)', quiz: 'sea',
    ...
    greet: '붉은 사막에 먼지 소용돌이가 돌아다녀. 저 멀리 탐사 로봇도 보여!', arrive: '화성에 도착! 붉은 사막과 골짜기, 하얀 얼음 모자가 있는 행성이야. 중력이 약해서 높이 뛸 수 있어. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'jupiter', zone: 'p_jupiter', name: '목성', emoji: '🟠', tint: '#d8a56a', title: '태양계에서 가장 큰 행성', gravity: 1.6, gravityText: '아주 세다 (낮게 뛴다)', quiz: 'volcano',
    ...
    greet: '구름 위를 걷고 있는 거야! 중력이 세서 점프가 낮아. 붉은 폭풍 근처는 조심.', arrive: '목성에 도착! 줄무늬 구름 위에 떠 있는 곳이야. 중력이 세서 점프가 낮고, 번개가 번쩍여. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'saturn', zone: 'p_saturn', name: '토성', emoji: '🪐', tint: '#e6cf8f', title: '아름다운 고리의 행성', gravity: 1.05, gravityText: '지구와 비슷', quiz: 'volcano',
    ...
    greet: '하늘을 올려다봐, 커다란 고리가 지나가! 북쪽엔 육각형 폭풍이 있어.', arrive: '토성에 도착! 하늘에 거대한 고리가 걸려 있고 얼음 조각이 반짝이는 곳이야. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'uranus', zone: 'p_uranus', name: '천왕성', emoji: '🩵', tint: '#8fd8e8', title: '옆으로 누워 도는 얼음 행성', gravity: 0.9, gravityText: '지구보다 조금 약함', quiz: 'sea',
    ...
    greet: '하늘의 고리가 세로로 서 있지? 이 행성은 옆으로 누워서 돌거든. 얼음 호수는 미끄러워서 못 들어가.', arrive: '천왕성에 도착! 청록색 얼음과 다이아몬드 수정, 세로로 선 고리가 있는 행성이야. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'neptune', zone: 'p_neptune', name: '해왕성', emoji: '🔵', tint: '#3f5fd8', title: '가장 멀고 바람이 센 푸른 행성', gravity: 1.15, gravityText: '지구보다 조금 셈', quiz: 'sea',
    ...
    greet: '바람이 엄청 세지? 구름이 휙휙 날아가. 파란 웅덩이는 깊어서 못 들어가.', arrive: '해왕성에 도착! 거센 바람에 구름이 날아가는 짙푸른 행성이야. 돌아갈 땐 UFO 정거장의 별이에게!' },
  { id: 'pluto', zone: 'p_pluto', name: '명왕성', emoji: '🤍', tint: '#c9b8a8', title: '하트를 가진 작은 얼음 세상', gravity: 0.3, gravityText: '아주 약하다 (둥둥 뜬다)', quiz: 'space',
    ...
    greet: '하트 모양 평원이 보여? 카론이 하늘에 크게 떠 있어. 중력이 약해서 둥둥 뜬 것처럼 걸어.', arrive: '명왕성에 도착! 하트 모양 얼음 평원과 커다란 카론이 떠 있는 어둡고 작은 세상이야. 중력이 아주 약해. 돌아갈 땐 UFO 정거장의 별이에게!' },
];
