 ...
 */
export function portrait(obj, key, { head = 0.84, zoom = 0.26 } = {}) {
  ...
  clone.traverse((o) => { if (o.isSprite || o.isLight) strip.push(o); });
  ...
  const r = Math.max(size.x * 0.45, size.y * zoom, 0.25); // 머리 주변만 보이게
