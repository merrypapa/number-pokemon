...
export const DEEP = {
  size: 270,
  spawn: { x: 0.0, z: 97.2 },          // 소용돌이에서 떨어져 내려오는 자리
  portal: { x: 0.0, z: 113.4 },         // 상승 해류 → 물의길
  surfaceY: 30,                    // 저 위에 보이는 수면
  gravity: 0.22,                   // 물속이라 아주 가볍다
  trench: { x: 0.0, z: -81.0, r: 40.5, d: 2.4 }, // 보스가 사는 해구 (가운데로 갈수록 깊다)
  wreck: { x: -62.1, z: 27.0 },        // 가라앉은 배
  mounds: [
    { x: -45.9, z: 59.4, r: 18.9, h: 2.2 }, { x: 48.6, z: 54.0, r: 20.2, h: 2.6 },
    { x: 72.9, z: -5.4, r: 21.6, h: 2.4 }, { x: -78.3, z: -10.8, r: 20.2, h: 2.3 },
    { x: 16.2, z: 8.1, r: 24.3, h: 1.8 }, { x: -24.3, z: -45.9, r: 18.9, h: 2.0 },
    { x: 59.4, z: -59.4, r: 20.2, h: 2.2 }, { x: -94.5, z: 62.1, r: 17.6, h: 2.0 },
    { x: 99.9, z: 72.9, r: 17.6, h: 2.1 }, { x: -102.6, z: -70.2, r: 18.9, h: 2.2 },
    { x: 105.3, z: -83.7, r: 17.6, h: 2.0 },
  ],
};

// 야생 포켓몬과 블록 자리는 먼저 정해 두고, 장식(바위·다시마)은 그 자리를 피해서 놓는다
const WILD_SPOTS = [
  [-13.5, 75.6], [21.6, 70.2], [-40.5, 40.5], [37.8, 32.4], [-67.5, 18.9], [64.8, 16.2], [-8.1, -8.1], [24.3, -24.3],
  [-48.6, -18.9], [54.0, -40.5], [-83.7, 32.4], [86.4, 43.2], [-29.7, -62.1], [40.5, -64.8], [-89.1, -40.5], [91.8, -27.0],
  [72.6, 108.8], [-115.9, -8.5], [109.1, 36.6], [98.6, -95.2], [10.8, 18.2], [-119.8, -69.7], [-54.2, 102.4], [65.4, -83.7],
];
const PICKUP_SPOTS = [
  [-8.1, 83.7], [29.7, 51.3], [-54.0, 5.4], [56.7, -16.2], [-21.6, -35.1], [35.1, -78.3], [-78.3, 54.0], [78.3, 64.8],
  [73.1, -88.9], [-122.6, 91.4], [-71.5, -70.0], [118.7, 91.6], [-51.8, 113.5], [9.6, 43.7], [-72.6, 108.5], [46.9, 114.8],
  [96.9, -49.5], [-87.2, -107.0], [-48.9, 25.4], [-122.2, 43.8], [-39.9, -46.8], [78.4, -4.7], [-45.3, -4.6], [50.3, -109.0],
  [116.9, -117.4], [61.4, 84.8], [-118.6, 70.8], [-32.9, 19.3], [-120.8, -111.5], [105.7, 108.7], [-38.3, -35.7], [6.1, 67.8],
];
