      ...
      if (ev === 'meet') {
        ...
        battle.start({
          ...
          onCaught: () => {
            ...
            if (c.data.id === 'm07' && !state.glow) { state.glow = true; player.lamp.intensity = 9; player.lamp.distance = 22; zones.cave.scene.fog.far = 75; say(`${c.data.name}가 동굴을 환하게 밝혀줘!`, { sec: 5 }); }
