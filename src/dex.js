...
const MAP_REGIONS = [
  ...
  { id: 'hive', x: 27, y: 19, rx: 6.5, ry: 5, icon: '🐝', fill: '#f4b400', desc: '푸른숲 서남쪽 큰 나무에 매달린 벌집 속. 육각형 벌집 칸 바닥, 빛나는 꿀 웅덩이, 천장에서 떨어지는 꿀 방울, 날아다니는 꿀벌 떼. 벌레·풀 포켓몬이 살고 북쪽 금빛 단에 대장 독침붕이 있어.', how: '푸른숲 서남쪽 큰 나무 아래 벌집에 닿으면 들어간다. 남쪽 초록 포탈로 나오면 그 나무 아래.' },
