...
const SHELL_FILES = [
  './', './index.html', './install.html', './style.css', './manifest.webmanifest',
  ...
  './src/arena.js', './src/balls.js', './src/battle.js', './src/bgm.js', './src/boat.js', './src/car.js', './src/cave.js', './src/cloud-config.js', './src/cloud.js', './src/creatures.js', './src/deepsea.js', './src/dex.js', './src/duel.js', './src/duelstage.js', './src/effects.js', './src/goals.js', './src/hive.js', './src/input.js', './src/intro.js', './src/lab.js', './src/learn.js', './src/main.js', './src/mega.js', './src/models.js', './src/npc.js', './src/numberblocks.js', './src/palette.js', './src/photo.js', './src/party.js', './src/planetquiz.js', './src/planets.js', './src/player.js', './src/portrait.js', './src/presence.js', './src/quiz.js', './src/rank.js', './src/rocket.js', './src/save.js', './src/sea.js', './src/space.js', './src/types.js', './src/ufo.js', './src/util.js', './src/view3d.js', './src/volcano.js', './src/world.js',
];
